            ...
            <div className="mb-4">
                <div className="flex flex-wrap justify-center gap-2">
                    ...
                    <button
                        ...
                        className={`border-2 bg-head-main ${
                            selectedHair === null ? "border-yellow-400" : "border-gray-400"
                        } rounded-md flex items-center justify-center btn-standard-padding`}
                    >
                    ...
                    {availableHair.map((hair) => (
                        <button
                            ...
                            className={`border-2 bg-head-main ${
                                selectedHair === hair ? "border-yellow-400" : "border-gray-400"
                            } rounded-md btn-standard-padding`}
                        >
                            <Image
                                src={hair}
                                alt="hair"
                ...
                <div className="flex flex-wrap justify-center gap-2 mt-6">
                    ...
                    <button
                        ...
                        className={`border-2 bg-head-main ${
                            selectedUpperBody === null ? "border-yellow-400" : "border-gray-400"
                        } rounded-md flex items-center justify-center btn-standard-padding`}
                    >
                        <span className="text-white text-lg font-bold">X</span>
                    </button>
                    {availableUpperBody.map((ub) => (
                        <button
                            ...
                            className={`border-2 bg-head-main ${
                                selectedUpperBody === ub ? "border-yellow-400" : "border-gray-400"
                            } rounded-md btn-standard-padding`}
                        >
                            <Image
                                src={ub}
