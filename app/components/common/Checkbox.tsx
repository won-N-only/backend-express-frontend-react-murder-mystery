...
const CHECKBOX_VISUAL_CLASS =
    "relative w-4 h-4 shrink-0 rounded border-2 border-head-border flex items-center justify-center after:absolute after:inset-0.5 after:rounded-[2px] after:bg-head-brown after:content-[''] after:opacity-0 peer-checked:after:opacity-100";
