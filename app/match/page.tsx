...
export default function MatchPage() {
    ...
    const showCombinationWarning = selectedPlayers.length > 0 && !isCombinationReady;
        ...
        <div>
            ...
            <div className="pt-section">
                ...
                <div className="mt-2 min-h-[48px]">
                    <p
                        className={`text-xs text-head-text/80 bg-head-white border border-head-border px-3 py-2 transition-opacity ${
                            showCombinationWarning ? "opacity-100" : "opacity-0 pointer-events-none"
                        }`}
                        aria-hidden={!showCombinationWarning}
                    >
            ...
            <div className="flex flex-row gap-2">
                ...
                <button
                    ...
                    className="mt-section block btn-primary btn-standard-padding"
                >
                    {isLoadingPlayableGames && fetchPlayableGames
                        ? "플레이 가능한 게임 로딩 중..."
                        : "플레이 가능한 게임 목록 보기"}
                </button>
            </div>
